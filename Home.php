...
?>
			...
			<div class="criar" id="frm1">
				...
				<form class="IntputsTexts" method="post" enctype="multipart/form-data">
					...
					<div class="InputTextIc">
						...
						<input type="tel" name="telefone" id="telefone" pattern="[0-9]{2}_[0-9]{4}-[0-9]{5}" class="InputText" placeholder="Telefone" minlength="12" maxlength="13">
	...
	<div class="sistem" id="sistem">
		...
		<main class="meio">
			<div class="div">
				<div class="palagrafy">
					<p class="textDiv">Venha ver o filme Dragon Ball Super Broly Em um dos Nossos Estacionamentos</p>
...
<?php
	...
	if(isset($_POST['UpdateUser'])){
		...
		$_SESSION['user'] = CadUser($dados[1], $dados[2], $dados[4], $dados[7], $dados[6], $dados[3], $dados[5], $dados[0],0);
		move('use.php');
	}
	if(isset($_POST['VerLog'])){
		$dados = array(
			$_POST['logNick'],//0
			Cripto($_POST['logSenha'])//1
		);
